...
pub fn build(b: *std.Build) !void {
    ...
    const build_config_h: *std.Build.Step.ConfigHeader = build_config_h: {
        ...
        break :build_config_h b.addConfigHeader(.{
            ...
            .HAVE_GCC_ATOMICS = windows or linux or macos or emscripten or android or ios,
            ...
            .HAVE_STRINGS_H = windows or linux or macos or emscripten or android or ios,
            ...
            .HAVE_DLOPEN = linux or android or macos or emscripten or ios,
            ...
            .HAVE_STRLCPY = macos or emscripten or ios,
            .HAVE_STRLCAT = macos or emscripten or ios,
            ...
            .HAVE_STRTOK_R = windows or linux or macos or emscripten or android or ios,
            .HAVE_ITOA = windows,
            .HAVE__LTOA = windows,
            .HAVE__UITOA = false,
            .HAVE__ULTOA = windows,
            ...
            .HAVE_PTHREAD_SETNAME_NP = linux or android or macos or ios,
            ...
            .SDL_THREAD_PTHREAD = linux or android or macos or ios or emscripten and emscripten_pthreads,
            .SDL_THREAD_PTHREAD_RECURSIVE_MUTEX = linux or android or ios or macos or emscripten and emscripten_pthreads,
            ...
            .SDL_TIME_UNIX = linux or android or macos or emscripten or ios,
            ...
            .SDL_TIMER_UNIX = linux or android or macos or emscripten or ios,
            ...
            .DYNAPI_NEEDS_DLOPEN = linux or android or macos or emscripten or ios,
            .SDL_USE_IME = linux,
